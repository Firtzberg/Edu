...
<div class = "form-group">
    ...
    {{ Form::text('broj_mobitela', isset($klijent)?Klijent::getReadableBrojMobitela($klijent->broj_mobitela):null,
$mobAttributes) }}
</div>
<div class = "form-group">
...
<div class = "form-group">
    {{ Form::label('Škola/Fakultet') }}
    {{ Form::text('skola', null,
$optional) }}
</div>
<div class = "form-group">
    {{ Form::label('Razred/Godina') }}
    {{ Form::input('number', 'razred', null,
$optional) }}
</div>
<div class = "form-group">
    {{ Form::label('Email') }}
...
<div class = "form-group">
    {{ Form::label('Ime roditelja') }}
    {{ Form::text('roditelj', null,
$optional) }}
</div>
<div class = "form-group">
    {{ Form::label('Broj roditelja') }}
    {{ Form::text('broj_roditelja', isset($klijent)?Klijent::getReadableBrojMobitela($klijent->broj_roditelja):null,
$optional) }}
</div>
<div class = "form-group">
